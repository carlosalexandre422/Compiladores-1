// Importa a AST do parser e HashSet para controle de variáveis
...
pub fn gerar_codigo(prog: &Programa) -> String {
    ...
    // Geração da seção .bss (variáveis globais não inicializadas)
    ...
    // Gera código para as declarações (inicializações)
